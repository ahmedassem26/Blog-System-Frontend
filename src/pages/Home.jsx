...
function Home() {
  ...
  if (isLoadingPosts) {
    return (
      <div className="min-h-screen flex justify-center items-center bg-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <div className="text-slate-400 text-sm">Fetching your posts</div>
          </div>
        ...
        {/* Corner accents */}
        <div className="absolute top-10 right-10 w-20 h-20 border-2 border-purple-500/20 rounded-full animate-pulse"></div>
        <div className="absolute bottom-10 left-10 w-16 h-16 border-2 border-blue-500/20 rounded-full animate-pulse delay-1000"></div>
      </div>
    );
  }
